...
with aba5:
    ...
    if not df_grafico_regioes.empty:
        fig_regioes = px.bar(
            ...
            y='Region',
            orientation='h',
            title='Pergunta 03: Top 10 Regiões com maior Número de Homicídios (Volume Total Acumulado)',
            text='VALUE',
    ...
    if not df_grafico_menor_homicidio.empty:
        fig_menor_homicidio = px.bar(
            ...
            color='Subregion',
            orientation='h',
            title='Pergunta 04: Países Líderes em Segurança: Menor Número de Homicídios por Sub-Região',
            text='VALUE',
    ...
    if not df_grafico_menores_mulheres.empty:
        fig_menores_mulheres = px.bar(
            ...
            y='Country',
            orientation='h',
            title='Pergunta 05: Top 10 Países com Menores Números de Homicídios de Mulheres<br><sup>(Volume Total Acumulado - Todos os Anos)</sup>',
            text='VALUE',
    ...
    if not df_grafico_subregiao.empty:
        fig_subregioes = px.bar(
            ...
            y='Subregion',
            orientation='h',
            title='Pergunta 06: Top 10 Sub-Regiões com maior Número de Homicídios<br><sup>(Volume Total Acumulado)</sup>',
            text='VALUE',
    ...
    if not df_homicidio_continentes.empty:
        ...
        fig_continentes = px.bar(
            ...
            color='Region',
            orientation='h',
            title='Pergunta 07: País com o Maior Número de Homicídios por Continente (Ano de Referência: 2020)',
            text='VALUE',
    ...
    if not df_mulheres_2021.empty:
        ...
        fig_mulheres_2021 = px.bar(
            ...
            y='Country',
            orientation='h',
            title='Pergunta 08: Top 10 Países Mais Violentos para Mulheres (Ano de Referência: 2021)',
            text='VALUE',
    ...
    if not df_grafico_absoluto.empty:
        fig_absoluto = px.bar(
            ...
            y='Country',
            orientation='h',
            title='Pergunta 09: Top 10 Maiores Valores Absolutos de Vítimas de Homicídio Intencional',
            text='VALUE',
    ...
    if not df_brasil_10anos.empty:
        ...
        fig_brasil_10anos = px.bar(
            ...
            y='Year',
            orientation='h',
            title='Pergunta 10: Evolução da Taxa de Homicídios no Brasil (2013-2022)',
            text='VALUE',
